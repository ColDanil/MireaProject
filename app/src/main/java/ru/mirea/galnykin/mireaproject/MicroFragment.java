 ...
 */
public class MicroFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_micro, container, false);
                    ...
                    try {
                        ...
                        while (isRecording) {
                            ...
                            new Handler(Looper.getMainLooper()).post(new Runnable() {
                                @Override
                                public void run() {
                                    amplitudeTextView.setText("Амплитуда звука: " + finalAmplitude);
                                }
                            });
                        }
                    } catch (Throwable t) {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == AUDIO_PERMISSION_REQUEST_CODE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(requireContext(), "Need audio permission", Toast.LENGTH_SHORT).show();
